...
% Lund University
%
% Example code 23: Estimating the unknown parameters of an ARMA process
...
ey = y0(600:N)-yhat(600:N);                     % Ignore the initial values to let the filter converge first.
checkIfWhite( ey );
